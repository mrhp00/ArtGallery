<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="Polls.aspx.cs" Inherits="Polls" Title="Untitled Page" EnableViewState="true"%>
                            ...
                            <tr>
                                <td>
                                    <Polls:PollControl ID="Pollcontrol1" runat="server" CSSCaption="PollCaption" CssClass="Normal"
                                        CSSPollClass="PollBack" Font-Names="tahoma" ImagesFolder="~/Images/PollImage/"
                                        OnCastVote="Pollcontrol1_CastVote" Style="font-family: tahoma" VotesCaption="تعداد آراء :"
                                        Width="100%" />
                                </td>
                            </tr>
                            <tr>
