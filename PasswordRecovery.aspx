<%@ Page enableViewState="false" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="PasswordRecovery.aspx.cs" Inherits="PasswordRecovery" Title="Untitled Page" %>
                ...
                <div class="mid-inner">
                    <div class="mid">
                        <asp:UpdatePanel id="UpdatePanel1" runat="server">
                            <contenttemplate>
<Safa:SafaPasswordRecovery id="SafaPasswordRecovery1" runat="server" Width="100%">
<MailDefinition From="saber_fatholahi@yahoo.com" Subject="باز یابی کلمه عبور" BodyFileName="~/PasswordRecoveryMail.txt"></MailDefinition>

<SubmitButtonStyle Width="120px" Font-Names="Tahoma"></SubmitButtonStyle>
</Safa:SafaPasswordRecovery>
</contenttemplate>
                        </asp:UpdatePanel>
                     </div>
                </div>
