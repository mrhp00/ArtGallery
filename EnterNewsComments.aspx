<%@ Page enableViewState="false" Language="C#" AutoEventWireup="true" CodeFile="EnterNewsComments.aspx.cs" Inherits="EnterNewsComments" EnableSessionState="true"%>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 80%">
                                        ...
                                        <Ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="TextBox_Name"
                                            WatermarkCssClass="WaterMark" WatermarkText="نام خود را اینجا وارد نمایید">
                                ...
                                <tr style="color: #000000">
                                    ...
                                    <td>
                                        ...
                                        <Ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" runat="server" TargetControlID="TextBox_Email"
                                            WatermarkCssClass="WaterMark" WatermarkText="ایمیل خود را اینجا وارد نمایید">
                                        </Ajax:TextBoxWatermarkExtender>
                                    </td>
                                </tr>
                                <tr style="color: #000000">
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <Ajax:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" TargetControlID="TextBox_Comment"
                                            WatermarkCssClass="WaterMark" WatermarkText="متن نظر خود را اینجا وارد نمایید">
                                        </Ajax:TextBoxWatermarkExtender>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="text-align: center">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource_EnterNewsComments" runat="server" ConnectionString="<%$ ConnectionStrings:LocalSqlServer1 %>"
                                            InsertCommand="News_InsertComments" InsertCommandType="StoredProcedure" OnInserted="SqlDataSource_EnterNewsComments_Inserted"
                                            ...
                                            <InsertParameters>
                                                ...
                                                <asp:SessionParameter DefaultValue="0" Name="NewsID" SessionField="NewsID" Type="Int32" />
